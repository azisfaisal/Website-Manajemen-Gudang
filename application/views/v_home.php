...
<section class="section">
  <div class="container" style="margin-top:5%;margin-bottom:5%;">
        <h2 class="text-center" style="color:#656565;">DATA PELANGGAN</h2>
        <hr class="my-4" style="width:100px;background-color:#656565;height:1px;">
        <a href="<?= base_url('Front/tampilUser')?>">
            <button type="submit" class="btn btnSubmit" name="submit" style="margin-top:2%;margin-bottom:2%;">+ Tambah Pemesan</button>
        </a>
        <?php if($count > 0){ ?>
            <table class="table">
                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $u->tgl_pesan ?></td>
                        <?php if($u->status == 0){?>
                            <td><a href="<?= base_url('Front/tampilPemesanan/'.$u->id) ?>"><span class="p-2 badge badge badge-danger">Belum Order</span></a></td>
                        <?php }else if($u->status == 1){ ?>
                            <td><a href="<?= base_url('Gudang') ?>"><span class="p-2 badge badge badge-primary text-white">Order</span></a></td>
                        <?php }else if($u->status == 2){ ?>
                            <td><a href="<?= base_url('Transaksi') ?>"><span class="p-2 badge badge badge-warning text-white">Transaksi</span></a></td>
                        <?php }else if($u->status == 3){ ?>
                            <td><span class="p-2 badge badge badge-success text-white">Done!</span></td>
                        <?php } ?>
                    </tr>
                    <?php } ?>
                </tbody>
        ...
        <?php }else{ ?>
            <h1 class="text-center" style="margin-top:10%;margin-bottom:10%;">TIDAK ADA DATA</h1>
        <?php } ?>
    </div>
</section>
<!-- /about -->
