...
<section class="section">
 <div class="container" style="margin-top:5%;margin-bottom:5%;">
        <h2 class="text-center" style="color:#656565;">DATA TRANSAKSI</h2>
        <hr class="my-4" style="width:100px;background-color:#656565;height:1px;">
        <a href="<?= base_url('Transaksi/tampilDiskon')?>">
        <button type="submit" class="btn btnSubmit float-left" name="submit" style="margin-top:3%;margin-bottom:3%;" >+ Tambah DISKON</button>
      </a>
        <?php if($count > 0){ ?>
        <table class="table text-center" style="margin-top:5%;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $u->nama ?></td>
                    <td><?= $u->tgl_pesan ?></td>
                    <td><?= $u->total_item ?> pcs</td>
                    <td>Rp. <?= $u->total_harga ?></td>
                    <td>
                        <a href="<?= base_url('Transaksi/tampilDetail/'.$u->id) ?>">
                            <span class="p-2 badge badge badge-primary">Lihat Detail</span>
                        </a>
                    </td>
        ...
        <?php }else{ ?>
        <h1 class="text-center" style="margin-top:10%;margin-bottom:10%;">TIDAK ADA TRANSAKSI</h1>
        <?php } ?>
    </div>
</section>
<!-- /about -->
