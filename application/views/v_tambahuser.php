...
<section class="section">
 <div class="container" style="margin-top:5%;margin-bottom:5%;">
        <h2 class="text-center" style="color:#656565;">TAMBAH PELANGGAN</h2>
        <hr class="my-4" style="width:100px;background-color:#656565;height:1px;">
        
        
        <form method="post" action="<?= site_url('Front/tambahUser')?>" class="col-md-6 offset-3">
            ...
            <button type="reset" class="btn btnReset" name="reset">Cancel</button>
        </form>
