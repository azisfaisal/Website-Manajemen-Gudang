...
<section class="section">
  <div class="container" style="margin-top:5%;margin-bottom:5%;">
        <h2 class="text-center" style="color:#656565;">DETAIL TRANSAKSI</h2>
        <hr class="my-4" style="width:100px;background-color:#656565;height:1px;">

        <div class="section" style="margin-top:5%;">
            <?php foreach($tampil1 as $t1){?>
            <h3 style="text-transform:uppercase;">SELAMAT DATANG, <?= $t1->nama;?></h3>
            <table class="table table-borderless col-md-4 my-2">
                <tr>
                    <td>
                        <h4>TOTAL ITEM</h4>
                    </td>
                    <td>
                        <h4>: <?= $t1->total_item; ?> pcs</h4>
                    </td>
                </tr>
                <tr>
                    <td>
            ...
            <table class="table text-center" style="margin-top:2%;">
                ...
                <tbody>
                    <?php $i=1; foreach($tampil2 as $t2){ ?>
                    <tr>
                        <td><?= $i ?></td>
                        <td><?= $t2->nama_barang ?></td>
                        <td><?= $t2->kuantitas ?></td>
                        <td>Rp. <?= $t2->total_harga ?></td>
                    </tr>
                    <?php $i++; } ?>
                </tbody>
            </table>

            <form method="post" action="<?= site_url('Transaksi/Pembayaran/'.$t1->id)?>" style="margin-top:5%;">
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                        </div>
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="bayar" placeholder="Masukan Pembayaran" required>
                        </div>
                        <div class="col-md-2">
            ...
            <div class="text-center">
                <h1>KEMBALIAN : <?= $t1->kembalian; ?></h1>
                <a href="<?= base_url('Transaksi')?>">
                    <button class="btn btnSubmit" style="margin-top:2%;"> < KEMBALI KE TRANSAKSI</button>
                </a>
            </div>
            <?php }?>
        </div>
